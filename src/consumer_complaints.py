...
#input_path = "C:/Users/Ching/Downloads/GitHub_Test1/complaints.csv"
#output_path = "C:/Users/Ching/Downloads/GitHub_Test1/report.csv"
...
#Read input file specified by input path; prepare data for processing
def read(input_path):
...
def UniqListAttr(data):
    ...
    return(product_unique,year_unique,company_unique)

#---------------------------------------------------------------------------------------------------
#Process prepared data to create output
def getReport(data,product_unique,year_unique,company_unique):
...
data1 = read(input_path)
p,y,c = UniqListAttr(data1)
report3 = getReport(data1,p,y,c)
output(report3)
